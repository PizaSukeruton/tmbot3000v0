...
# Replace the travel_time_query handler with one that uses real hotel data
sed -i '' '/case "travel_time_query":/,/^        }/c\
...
echo "✅ Updated travel_time_query handler to use real hotel data"
